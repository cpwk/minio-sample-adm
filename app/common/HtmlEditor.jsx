...
import {CTYPE, OSSWrap, U, Utils} from "./index";
...
export default class HtmlEditor extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            withoutTools: this.props.withoutTools
        };
    }
        ...
        if (images.length) {
            ...
            if (!image.name) {
                ...
                reader.onload = (e) => {
                    ...
                    image.name = hash + '.jpg';
                    OSSWrap.upload(image, CTYPE.namespace.file).then((result) => {
    ...
    videoBeforeUpload = (e, editor, $video) => {
        ...
        OSSWrap.upload($video[0], CTYPE.namespace.file).then((result) => {
    ...
    render() {
        ...
        let {model = '', withoutTools} = this.state;
        ...
        return (
            <div className="html-editor">
                ...
                {!withoutTools && <ul className='cz-addon'>
                    <li>
